...
module hNNewMatrixC
  ...
  wire HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_27_0_1;
  wire HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_0_19;
  reg  HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_0_19_1;
  wire enb_gated;
  ...
  reg [4:0] rd_1_regin;  // ufix5
  reg [2:0] rd_1_waddr;  // ufix3
  wire rd_1_wrenb;  // ufix1
  reg [2:0] rd_1_raddr;  // ufix3
  wire [4:0] rd_1_regout;  // ufix5
  ...
  wire HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_8_18_1;
  wire enb_gated_1;
  ...
  always @(posedge clk)
    begin : rd_5_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          rd_5_reg[0] <= HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_27_0;
          rd_5_reg[32'sd3:32'sd1] <= rd_5_reg[32'sd2:32'sd0];
        end
      end
    end

  assign HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_27_0_1 = rd_5_reg[3];
  ...
  always @(posedge clk)
    begin : rd_0_process
      if (reset == 1'b1) begin
        HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_0_19_1 <= 1'b0;
      end
      else begin
        if (enb) begin
          HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_0_19_1 <= HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_0_19;
        end
      end
    end
  ...
  // Input register for RAM-based shift register rd_1
  always @(posedge clk)
    begin : rd_1_reginc_process
      if (reset == 1'b1) begin
        rd_1_regin <= 5'b00000;
      end
      else begin
        if (enb) begin
          rd_1_regin <= counterSig;
        end
      end
    end
  ...
  //  step value      = 1
  //  count to value  = 4
  // Write address counter for RAM-based shift register rd_1
  always @(posedge clk)
    begin : rd_1_wr_process
      if (reset == 1'b1) begin
        rd_1_waddr <= 3'b000;
      end
      else begin
        if (enb) begin
          if (rd_1_waddr >= 3'b100) begin
            rd_1_waddr <= 3'b000;
          end
          else begin
            rd_1_waddr <= rd_1_waddr + 3'b001;
          end
        end
      end
    end

  assign rd_1_wrenb = 1'b1;

  // Count limited, Unsigned Counter
  //  initial value   = 1
  //  step value      = 1
  //  count to value  = 4
  // Read address counter for RAM-based shift register rd_1
  always @(posedge clk)
    begin : rd_1_rd_process
      if (reset == 1'b1) begin
        rd_1_raddr <= 3'b001;
      end
      else begin
        if (enb) begin
          if (rd_1_raddr >= 3'b100) begin
            rd_1_raddr <= 3'b000;
          end
          else begin
            rd_1_raddr <= rd_1_raddr + 3'b001;
          end
        end
      end
    end
  ...
  ShiftRegisterRAM_Wrapper_generic #(.AddrWidth(3),
                                   ...
                                   u_ShiftRegisterRAM_Wrapper (.clk(clk),
                                                               ...
                                                               .wr_din(rd_1_regin),
                                                               .wr_addr(rd_1_waddr),
                                                               .wr_en(rd_1_wrenb),  // ufix1
                                                               .rd_addr(rd_1_raddr),
                                                               .dout(rd_1_regout)
                                                               );

  // Output register for RAM-based shift register rd_1
  always @(posedge clk)
    begin : rd_1_regoutc_process
      if (reset == 1'b1) begin
        counterSig_1 <= 5'b00000;
      end
      else begin
        if (enb) begin
          counterSig_1 <= rd_1_regout;
        end
      end
    end
  ...
  assign dot_product1 = (HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_27_0_1 == 1'b0 ? dot_product1_held :
              dot_product20);
  ...
  // <S179>/Fixed-Point State-Space
  assign out_DTC1 = dot_product1_1[44:20] + $signed({1'b0, dot_product1_1[19]});
  ...
  always @(posedge clk)
    begin : rd_3_process
      if (reset == 1'b1) begin
        enb_counter_le_26_2 <= 1'b0;
      end
      else begin
        if (enb) begin
          enb_counter_le_26_2 <= enb_counter_le_26_1;
        end
      end
    end

  assign HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_8_18 = enb_counter_ge_8_2 & enb_counter_le_26_2;
  ...
  always @(posedge clk)
    begin : rd_4_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          rd_4_reg[0] <= HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_8_18;
          rd_4_reg[32'sd2:32'sd1] <= rd_4_reg[32'sd1:32'sd0];
        end
      end
    end

  assign HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_8_18_1 = rd_4_reg[2];

  assign enb_gated_1 = HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixC_shared_enb_phase_8_18_1 && enb;
  ...
  assign matrixCOutSignal_1 = out_DTC2_1;
  ...
  assign matrixCOutSignal_2 = out_DTC3_1;
  ...
  assign matrixCOutSignal_3 = out_DTC4_1;
  ...
  assign matrixCOutSignal_4 = out_DTC5_1;
  ...
  assign matrixCOutSignal_5 = out_DTC6_1;
  ...
  assign matrixCOutSignal_6 = out_DTC7_1;
  ...
  always @(posedge clk)
    begin : rd_7_process
      if (reset == 1'b1) begin
        out_DTC8_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC8_1 <= out_DTC8;
  ...
  assign matrixCOutSignal_7 = out_DTC8_1;
  ...
  always @(posedge clk)
    begin : rd_8_process
      if (reset == 1'b1) begin
        out_DTC9_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC9_1 <= out_DTC9;
  ...
  assign matrixCOutSignal_8 = out_DTC9_1;
  ...
  always @(posedge clk)
    begin : rd_9_process
      if (reset == 1'b1) begin
        out_DTC10_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC10_1 <= out_DTC10;
        end
      end
    end

  assign matrixCOutSignal_9 = out_DTC10_1;
  ...
  always @(posedge clk)
    begin : rd_10_process
      if (reset == 1'b1) begin
        out_DTC11_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC11_1 <= out_DTC11;
        end
      end
    end

  assign matrixCOutSignal_10 = out_DTC11_1;
  ...
  always @(posedge clk)
    begin : rd_11_process
      if (reset == 1'b1) begin
        out_DTC12_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC12_1 <= out_DTC12;
        end
      end
    end

  assign matrixCOutSignal_11 = out_DTC12_1;
  ...
  always @(posedge clk)
    begin : rd_12_process
      if (reset == 1'b1) begin
        out_DTC13_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC13_1 <= out_DTC13;
        end
      end
    end

  assign matrixCOutSignal_12 = out_DTC13_1;
  ...
  always @(posedge clk)
    begin : rd_13_process
      if (reset == 1'b1) begin
        out_DTC14_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC14_1 <= out_DTC14;
        end
      end
    end

  assign matrixCOutSignal_13 = out_DTC14_1;
  ...
  always @(posedge clk)
    begin : rd_14_process
      if (reset == 1'b1) begin
        out_DTC15_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC15_1 <= out_DTC15;
        end
      end
    end

  assign matrixCOutSignal_14 = out_DTC15_1;
  ...
  always @(posedge clk)
    begin : rd_15_process
      if (reset == 1'b1) begin
        out_DTC16_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC16_1 <= out_DTC16;
        end
      end
    end

  assign matrixCOutSignal_15 = out_DTC16_1;
  ...
  always @(posedge clk)
    begin : rd_16_process
      if (reset == 1'b1) begin
        out_DTC17_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC17_1 <= out_DTC17;
        end
      end
    end

  assign matrixCOutSignal_16 = out_DTC17_1;
  ...
  always @(posedge clk)
    begin : rd_17_process
      if (reset == 1'b1) begin
        out_DTC18_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC18_1 <= out_DTC18;
        end
      end
    end

  assign matrixCOutSignal_17 = out_DTC18_1;
  ...
  always @(posedge clk)
    begin : rd_18_process
      if (reset == 1'b1) begin
        out_DTC19_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC19_1 <= out_DTC19;
        end
      end
    end

  assign matrixCOutSignal_18 = out_DTC19_1;
  ...
  always @(posedge clk)
    begin : rd_19_process
      if (reset == 1'b1) begin
        out_DTC20_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          out_DTC20_1 <= out_DTC20;
        end
      end
    end

  assign matrixCOutSignal_19 = out_DTC20_1;
