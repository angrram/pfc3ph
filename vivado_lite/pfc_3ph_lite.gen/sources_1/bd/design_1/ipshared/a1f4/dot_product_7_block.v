// -------------------------------------------------------------
// 
// File Name: hdl_prj2\hdlsrc\HDL_pfc_gold_fi_og\dot_product_7_block.v
...
// Source Path: HDL_pfc_gold_fi_og/simscape_system/HDL Subsystem/Fixed-Point State-Space/hNNewMatrixD/dot_product_7
// Hierarchy Level: 3
// Model version: 1.239
// 
// -------------------------------------------------------------
...
module dot_product_7_block
  ...
  wire signed [24:0] delayOut0;  // sfix25_En19
  wire [24:0] slicedInput_1;  // ufix25
  wire signed [24:0] delayOut1;  // sfix25_En19
  wire [24:0] slicedInput_2;  // ufix25
  wire signed [24:0] delayOut2;  // sfix25_En19
  wire [24:0] slicedInput_3;  // ufix25
  wire signed [24:0] delayOut3;  // sfix25_En19
  wire [24:0] slicedInput_4;  // ufix25
  wire signed [24:0] delayOut4;  // sfix25_En19
  wire [24:0] slicedInput_5;  // ufix25
  wire signed [24:0] delayOut5;  // sfix25_En19
  wire [24:0] slicedInput_6;  // ufix25
  wire signed [24:0] delayOut6;  // sfix25_En19
  ...
  reg signed [49:0] sum_stage1_4;  // sfix50_En32
  ...
  always @(posedge clk)
    begin : mergedDelay_wr_1_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (mergedDelay_waddr_1 >= 3'b100) begin
            mergedDelay_waddr_1 <= 3'b000;
          end
          else begin
  ...
  always @(posedge clk)
    begin : mergedDelay_rd_1_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (mergedDelay_raddr_1 >= 3'b100) begin
  ...
  always @(posedge clk)
    begin : rd_4_process
      if (reset == 1'b1) begin
        sum_stage1_4 <= 50'sh0000000000000;
      end
      else begin
        if (enb) begin
          sum_stage1_4 <= mul_out1_6;
        end
      end
    end
