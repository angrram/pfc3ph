...
module HDL_Subsystem
  ...
  reg signed [24:0] rd_4_reg [0:39];  // sfix25 [40]
  reg signed [24:0] rd_4_reg_next [0:39];  // sfix25_En13 [40]
  ...
  reg  streaming_partition_streamed_enb_phase_0_6_1;
  wire enb_gated_1;
  ...
  reg [2:0] rd_2_reg [0:3];  // ufix3 [4]
  reg [2:0] rd_2_reg_next [0:3];  // ufix3 [4]
  ...
  reg signed [24:0] rd_4_reg_1 [0:1];  // sfix25 [2]
  wire signed [24:0] rd_4_reg_next_1 [0:1];  // sfix25_En13 [2]
  wire signed [24:0] matrixBOutSignal_unbuffer_1;  // sfix25_En13
  wire [2:0] slicedInput_4;  // ufix3
  wire streaming_partition_streamed_enb_phase_6_0;
  reg  [1:0] rd_6_reg;  // ufix1 [2]
  wire streaming_partition_streamed_enb_phase_6_0_1;
  wire slicedInput_5;  // ufix1
  wire streaming_partition_streamed_enb_phase_14_5_1;
  wire enb_gated_2;
  wire streaming_partition_streamed_enb_phase_20_0;
  reg  [5:0] rd_9_reg;  // ufix1 [6]
  wire streaming_partition_streamed_enb_phase_20_0_1;
  wire streaming_partition_streamed_enb_phase_0_5;
  reg  streaming_partition_streamed_enb_phase_0_5_1;
  wire enb_gated_3;
  reg signed [24:0] delayOutSignal [0:5];  // sfix25_En13 [6]
  ...
  reg signed [24:0] State_out_7 [0:6];  // sfix25_En13 [7]
  ...
  reg signed [24:0] delayOutSignal_2;  // sfix25_En13
  wire signed [24:0] delayOutSignal_3;  // sfix25_En13
  reg signed [24:0] delayOutSignal_held;  // sfix25_En13
  reg signed [24:0] delayOutSignal_4 [0:5];  // sfix25_En13 [6]
  wire signed [24:0] delayOutSignal_5;  // sfix25_En13
  wire signed [24:0] delayOutSignal_4_1;  // sfix25_En13
  wire signed [24:0] delayOutSignal_3_1;  // sfix25_En13
  ...
  reg signed [24:0] matrixAOutSignal_unbuffer_1;  // sfix25_En13
  ...
  wire signed [24:0] State_out_8 [0:6];  // sfix25_En13 [7]
  ...
  wire signed [24:0] delayOutSignal_6 [0:5];  // sfix25_En13 [6]
  ...
  reg signed [31:0] rd_4_t_0_0_1;  // int32
  ...
  reg signed [31:0] rd_4_t_0_0_2;  // int32
  reg signed [31:0] rd_4_t_1_1;  // int32


  assign enb_counter_ge_13_1 = sch_ctr_48 >= 6'b001101;

  always @(posedge clk)
    begin : rd_0_process
      if (reset == 1'b1) begin
        enb_counter_ge_13_2 <= 1'b0;
      end
      else begin
        if (enb) begin
          enb_counter_ge_13_2 <= enb_counter_ge_13_1;
        end
      end
    end

  assign enb_counter_le_19_1 = sch_ctr_48 <= 6'b010011;

  always @(posedge clk)
    begin : rd_1_process
      if (reset == 1'b1) begin
        enb_counter_le_19_2 <= 1'b0;
      end
      else begin
        if (enb) begin
          enb_counter_le_19_2 <= enb_counter_le_19_1;
        end
      end
    end

  assign streaming_partition_streamed_enb_phase_13_6 = enb_counter_ge_13_2 & enb_counter_le_19_2;

  assign enb_gated = streaming_partition_streamed_enb_phase_13_6 && enb;
  ...
  assign enb_counter_ge_14_1 = sch_ctr_48 >= 6'b001110;

  always @(posedge clk)
    begin : rd_6_process
      if (reset == 1'b1) begin
        enb_counter_ge_14_2 <= 1'b0;
      end
      else begin
        if (enb) begin
          enb_counter_ge_14_2 <= enb_counter_ge_14_1;
        end
      end
    end

  assign enb_counter_le_19_3 = sch_ctr_48 <= 6'b010011;

  always @(posedge clk)
    begin : rd_7_process
      if (reset == 1'b1) begin
        enb_counter_le_19_4 <= 1'b0;
      end
      else begin
        if (enb) begin
          enb_counter_le_19_4 <= enb_counter_le_19_3;
        end
      end
    end

  assign streaming_partition_streamed_enb_phase_14_5 = enb_counter_ge_14_2 & enb_counter_le_19_4;

  assign mergedInput = {counterSig, streaming_partition_streamed_enb_phase_14_5, I_load_in, va, vb, vc};

  // Input register for RAM-based shift register mergedDelay
  always @(posedge clk)
    begin : mergedDelay_reginc_process
      if (reset == 1'b1) begin
        mergedDelay_regin <= 76'h0000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : mergedDelay_regoutc_process
      if (reset == 1'b1) begin
        mergedOutput <= 76'h0000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : rd_4_process
      if (reset == 1'b1) begin
        for(rd_4_t_1 = 32'sd0; rd_4_t_1 <= 32'sd39; rd_4_t_1 = rd_4_t_1 + 32'sd1) begin
          rd_4_reg[rd_4_t_1] <= 25'sb0000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_4_t_0_1 = 32'sd0; rd_4_t_0_1 <= 32'sd39; rd_4_t_0_1 = rd_4_t_0_1 + 32'sd1) begin
  ...
  always @* begin
    ...
    for(rd_4_t_0_0 = 32'sd0; rd_4_t_0_0 <= 32'sd19; rd_4_t_0_0 = rd_4_t_0_0 + 32'sd1) begin
      matrixDOutSignal_20[rd_4_t_0_0] = rd_4_reg[32'sd20 + rd_4_t_0_0];
      rd_4_reg_next[rd_4_t_0_0] = matrixDOutSignal[rd_4_t_0_0];
      rd_4_reg_next[rd_4_t_0_0 + 32'sd20] = rd_4_reg[rd_4_t_0_0];
    end
  ...
  assign streaming_partition_streamed_enb_phase_0_6 = sch_ctr_48 <= 6'b000110;

  always @(posedge clk)
    begin : rd_1_1_process
      if (reset == 1'b1) begin
        streaming_partition_streamed_enb_phase_0_6_1 <= 1'b0;
      end
      else begin
        if (enb) begin
          streaming_partition_streamed_enb_phase_0_6_1 <= streaming_partition_streamed_enb_phase_0_6;
        end
      end
    end

  assign enb_gated_1 = streaming_partition_streamed_enb_phase_0_6_1 && enb;
  ...
  assign State_Initial_Val_out_unbuffer = (counterSig_1 == 3'b000 ? State_Initial_Val_out_0 :
              (counterSig_1 == 3'b001 ? State_Initial_Val_out_1 :
              (counterSig_1 == 3'b010 ? State_Initial_Val_out_2 :
              (counterSig_1 == 3'b011 ? State_Initial_Val_out_3 :
              (counterSig_1 == 3'b100 ? State_Initial_Val_out_4 :
              (counterSig_1 == 3'b101 ? State_Initial_Val_out_5 :
              State_Initial_Val_out_6))))));

  always @(posedge clk)
    begin : rd_2_1_process
      if (reset == 1'b1) begin
        for(rd_2_t_1 = 32'sd0; rd_2_t_1 <= 32'sd3; rd_2_t_1 = rd_2_t_1 + 32'sd1) begin
          rd_2_reg[rd_2_t_1] <= 3'b000;
        end
      end
      else begin
        if (enb) begin
          for(rd_2_t_0_1 = 32'sd0; rd_2_t_0_1 <= 32'sd3; rd_2_t_0_1 = rd_2_t_0_1 + 32'sd1) begin
    ...
    begin : rd_4_1_process
      if (reset == 1'b1) begin
        for(rd_4_t_1 = 32'sd0; rd_4_t_1 <= 32'sd1; rd_4_t_1 = rd_4_t_1 + 32'sd1) begin
          rd_4_reg_1[rd_4_t_1] <= 25'sb0000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_4_t_0_0_1 = 32'sd0; rd_4_t_0_0_1 <= 32'sd1; rd_4_t_0_0_1 = rd_4_t_0_0_1 + 32'sd1) begin
            rd_4_reg_1[rd_4_t_0_0_1] <= rd_4_reg_next_1[rd_4_t_0_0_1];
          end
        end
      end
    end

  assign matrixBOutSignal_unbuffer_1 = rd_4_reg_1[1];
  assign rd_4_reg_next_1[0] = matrixBOutSignal_unbuffer;
  assign rd_4_reg_next_1[1] = rd_4_reg_1[0];

  assign slicedInput_4 = mergedOutput[75:73];

  assign streaming_partition_streamed_enb_phase_6_0 = sch_ctr_48 == 6'b000110;
  ...
  always @(posedge clk)
    begin : rd_6_1_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          rd_6_reg[0] <= streaming_partition_streamed_enb_phase_6_0;
          rd_6_reg[1] <= rd_6_reg[0];
        end
      end
    end

  assign streaming_partition_streamed_enb_phase_6_0_1 = rd_6_reg[1];

  assign slicedInput_5 = mergedOutput[72];

  assign streaming_partition_streamed_enb_phase_14_5_1 = slicedInput_5;

  assign enb_gated_2 = streaming_partition_streamed_enb_phase_14_5_1 && enb;

  assign streaming_partition_streamed_enb_phase_20_0 = sch_ctr_48 == 6'b010100;
  ...
  always @(posedge clk)
    begin : rd_9_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          rd_9_reg[0] <= streaming_partition_streamed_enb_phase_20_0;
          rd_9_reg[32'sd5:32'sd1] <= rd_9_reg[32'sd4:32'sd0];
        end
      end
    end

  assign streaming_partition_streamed_enb_phase_20_0_1 = rd_9_reg[5];

  assign streaming_partition_streamed_enb_phase_0_5 = sch_ctr_48 <= 6'b000101;

  always @(posedge clk)
    begin : rd_3_process
      if (reset == 1'b1) begin
        streaming_partition_streamed_enb_phase_0_5_1 <= 1'b0;
      end
      else begin
        if (enb) begin
          streaming_partition_streamed_enb_phase_0_5_1 <= streaming_partition_streamed_enb_phase_0_5;
        end
      end
    end

  assign enb_gated_3 = streaming_partition_streamed_enb_phase_0_5_1 && enb;
  ...
  assign delayInSignal = (streaming_partition_streamed_enb_phase_20_0_1 == 1'b0 ? delayInSignal_held :
              sumStateEqOutSignal);

  always @(posedge clk)
    begin : rd_5_process
      if (reset == 1'b1) begin
        delayOutSignal_2 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          delayOutSignal_2 <= delayOutSignal_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : delayOutSignal_state_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          delayOutSignal_held <= delayOutSignal_3;
        end
      end
    end

  assign delayOutSignal_3 = (streaming_partition_streamed_enb_phase_6_0_1 == 1'b0 ? delayOutSignal_held :
              delayOutSignal_2);

  assign delayOutSignal_5 = delayOutSignal_4[5];

  assign delayOutSignal_4_1 = delayOutSignal_4[4];

  assign delayOutSignal_3_1 = delayOutSignal_4[3];

  assign delayOutSignal_2_1 = delayOutSignal_4[2];

  assign delayOutSignal_1_1 = delayOutSignal_4[1];
  ...
  hNNewMatrixA u_Sparse_Matrix_Vector_Product1 (.clk(clk),
                                                ...
                                                .delayOutSignal_3(delayOutSignal_3_1),  // sfix25_En13
                                                .delayOutSignal_4(delayOutSignal_4_1),  // sfix25_En13
                                                .delayOutSignal_5(delayOutSignal_5),  // sfix25_En13
                                                .delayOutSignal_6(delayOutSignal_3),  // sfix25_En13
                                                .enb_counter(sch_ctr_48),  // ufix6
  ...
  assign matrixAOutSignal_unbuffer = (slicedInput_4 == 3'b000 ? matrixAOutSignal_0 :
              (slicedInput_4 == 3'b001 ? matrixAOutSignal_1 :
              (slicedInput_4 == 3'b010 ? matrixAOutSignal_2 :
              (slicedInput_4 == 3'b011 ? matrixAOutSignal_3 :
              (slicedInput_4 == 3'b100 ? matrixAOutSignal_4 :
              (slicedInput_4 == 3'b101 ? matrixAOutSignal_5 :
              matrixAOutSignal_6))))));

  always @(posedge clk)
    begin : rd_5_1_process
      if (reset == 1'b1) begin
        matrixAOutSignal_unbuffer_1 <= 25'sb0000000000000000000000000;
      end
      else begin
        if (enb) begin
          matrixAOutSignal_unbuffer_1 <= matrixAOutSignal_unbuffer;
        end
      end
    end
  ...
  // <S179>/Fixed-Point State-Space
  // <S179>/Fixed-Point State-Space
  assign sumStateEqOutSignal = matrixBOutSignal_unbuffer_1 + matrixAOutSignal_unbuffer_1;
  ...
  always @* begin
    if (enb_1_49_1 == 1'b1) begin
      for(State_bypass_t_1 = 32'sd0; State_bypass_t_1 <= 32'sd6; State_bypass_t_1 = State_bypass_t_1 + 32'sd1) begin
        State_out_7[State_bypass_t_1] = delayInSignal_3[State_bypass_t_1];
      end
    end
    else begin
      for(State_bypass_t_0_0 = 32'sd0; State_bypass_t_0_0 <= 32'sd6; State_bypass_t_0_0 = State_bypass_t_0_0 + 32'sd1) begin
        State_out_7[State_bypass_t_0_0] = State_bypass_reg[State_bypass_t_0_0];
      end
    end
  ...
  assign State_out_8[0] = State_out_7[0];
  assign State_out_8[1] = State_out_7[1];
  assign State_out_8[2] = State_out_7[2];
  assign State_out_8[3] = State_out_7[3];
  assign State_out_8[4] = State_out_7[4];
  assign State_out_8[5] = State_out_7[5];
  assign State_out_8[6] = State_out_7[6];

  always @(posedge clk)
    begin : rd_0_1_process
      if (reset == 1'b1) begin
        for(rd_0_t_1 = 32'sd0; rd_0_t_1 <= 32'sd6; rd_0_t_1 = rd_0_t_1 + 32'sd1) begin
          State_out[rd_0_t_1] <= 25'sb0000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_0_t_0_0 = 32'sd0; rd_0_t_0_0 <= 32'sd6; rd_0_t_0_0 = rd_0_t_0_0 + 32'sd1) begin
            State_out[rd_0_t_0_0] <= State_out_8[rd_0_t_0_0];
          end
        end
      end
    end
  ...
  assign State_out_unbuffer = (counterSig_1 == 3'b000 ? State_out_0 :
              (counterSig_1 == 3'b001 ? State_out_1 :
              (counterSig_1 == 3'b010 ? State_out_2 :
              (counterSig_1 == 3'b011 ? State_out_3 :
              (counterSig_1 == 3'b100 ? State_out_4 :
              (counterSig_1 == 3'b101 ? State_out_5 :
              State_out_6))))));

  assign delayOutSignal_1 = (State_ctrl_delay_out_2 == 1'b0 ? State_Initial_Val_out_unbuffer :
              State_out_unbuffer);
  ...
  always @* begin
    ...
    for(tapped_delay_t_0_01 = 32'sd0; tapped_delay_t_0_01 <= 32'sd5; tapped_delay_t_0_01 = tapped_delay_t_0_01 + 32'sd1) begin
      delayOutSignal[tapped_delay_t_0_01] = tapped_delay_reg_1[tapped_delay_t_0_01];
    end
  ...
  assign delayOutSignal_6[0] = delayOutSignal[0];
  assign delayOutSignal_6[1] = delayOutSignal[1];
  assign delayOutSignal_6[2] = delayOutSignal[2];
  assign delayOutSignal_6[3] = delayOutSignal[3];
  assign delayOutSignal_6[4] = delayOutSignal[4];
  assign delayOutSignal_6[5] = delayOutSignal[5];

  always @(posedge clk)
    begin : rd_4_2_process
      if (reset == 1'b1) begin
        for(rd_4_t_1_1 = 32'sd0; rd_4_t_1_1 <= 32'sd5; rd_4_t_1_1 = rd_4_t_1_1 + 32'sd1) begin
          delayOutSignal_4[rd_4_t_1_1] <= 25'sb0000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_4_t_0_0_2 = 32'sd0; rd_4_t_0_0_2 <= 32'sd5; rd_4_t_0_0_2 = rd_4_t_0_0_2 + 32'sd1) begin
            delayOutSignal_4[rd_4_t_0_0_2] <= delayOutSignal_6[rd_4_t_0_0_2];
          end
        end
      end
    end

  assign delayOutSignal_0 = delayOutSignal_4[0];
