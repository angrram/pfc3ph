...
module ShiftRegisterRAM_Wrapper_generic
  ...
  wire bypass1_and;
  wire ram_is_down3;
  reg signed [DataWidth - 1:0] wr_din_last_value;  // sfix18_En8
  wire signed [DataWidth - 1:0] wr_din_1;  // sfix18_En8
  reg [AddrWidth - 1:0] wr_addr_last_value;  // ufix6
  wire [AddrWidth - 1:0] wr_addr_1;  // ufix6
  reg  wr_en_last_value;  // ufix1
  wire wr_en_1;  // ufix1
  reg [AddrWidth - 1:0] rd_addr_last_value;  // ufix6
  wire [AddrWidth - 1:0] rd_addr_1;  // ufix6
  wire signed [DataWidth - 1:0] dout_1;  // sfix18_En8
  wire ram_is_down4;
  reg signed [DataWidth - 1:0] dout_last_value;  // sfix18_En8
  wire signed [DataWidth - 1:0] dout_bypass_1;  // sfix18_En8
  reg signed [DataWidth - 1:0] dout_bypass_last_value;  // sfix18_En8
  wire signed [DataWidth - 1:0] dout_bypass_bypass;  // sfix18_En8
