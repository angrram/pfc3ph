// -------------------------------------------------------------
// 
// File Name: hdl_prj2\hdlsrc\HDL_pfc_gold_fi_og\dot_product_9.v
...
// Source Path: HDL_pfc_gold_fi_og/simscape_system/HDL Subsystem/Fixed-Point State-Space/hNNewMatrixB/dot_product_9
// Hierarchy Level: 3
// Model version: 1.239
// 
// -------------------------------------------------------------
...
module dot_product_9
  ...
  reg signed [49:0] rd_6_reg [0:1];  // sfix50 [2]
  wire signed [49:0] rd_6_reg_next [0:1];  // sfix50_En44 [2]
  wire signed [49:0] sum_stage3_2;  // sfix50_En44
    ...
    begin : rd_6_process
      if (reset == 1'b1) begin
        for(rd_6_t_1 = 32'sd0; rd_6_t_1 <= 32'sd1; rd_6_t_1 = rd_6_t_1 + 32'sd1) begin
          rd_6_reg[rd_6_t_1] <= 50'sh0000000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  assign sum_stage3_2 = rd_6_reg[1];
  assign rd_6_reg_next[0] = mul_out1_8;
