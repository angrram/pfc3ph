...
(* CHECK_LICENSE_TYPE = "design_1_PFC3PH_0_0,simscape_system,{}" *) (* CORE_GENERATION_INFO = "design_1_PFC3PH_0_0,simscape_system,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=PFC3PH,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, clk_enable, UP_L1, DW_L1, UP_L2, DW_L2, 
  UP_L3, DW_L3, I_load_in, va_i, vb_i, vc_i, O_Ia, O_Ib, O_Ic, O_Vc, O_Vb, O_Va, O_Vout, O_I_load)
/* synthesis syn_black_box black_box_pad_pin="reset,clk_enable,UP_L1,DW_L1,UP_L2,DW_L2,UP_L3,DW_L3,I_load_in[17:0],va_i[17:0],vb_i[17:0],vc_i[17:0],O_Ia[7:0],O_Ib[7:0],O_Ic[7:0],O_Vc[7:0],O_Vb[7:0],O_Va[7:0],O_Vout[7:0],O_I_load[7:0]" */
