...
(* CHECK_LICENSE_TYPE = "design_1_MCP_DRIVER_0_0,SPI_DAC,{}" *) (* CORE_GENERATION_INFO = "design_1_MCP_DRIVER_0_0,SPI_DAC,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=MCP_DRIVER,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst, clk_enable, numer_vx, v1_1, v1_2, v2_1, v2_2, 
  v3_1, v3_2, SDI, SCK, nCS1, nCS2, nCS3)
/* synthesis syn_black_box black_box_pad_pin="rst,clk_enable,numer_vx[7:0],v1_1[7:0],v1_2[7:0],v2_1[7:0],v2_2[7:0],v3_1[7:0],v3_2[7:0],SDI,SCK,nCS1,nCS2,nCS3" */
