...
(* CHECK_LICENSE_TYPE = "design_1_sine_3ph_0_0,sine_3ph,{}" *) (* CORE_GENERATION_INFO = "design_1_sine_3ph_0_0,sine_3ph,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=sine_3ph,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "package_project" *) (* X_CORE_INFO = "sine_3ph,Vivado 2024.2" *) 
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, clk_enable, out_vc, out_vb, 
  alphaout_va)
/* synthesis syn_black_box black_box_pad_pin="reset,clk_enable,out_vc[17:0],out_vb[17:0],alphaout_va[17:0]" */
