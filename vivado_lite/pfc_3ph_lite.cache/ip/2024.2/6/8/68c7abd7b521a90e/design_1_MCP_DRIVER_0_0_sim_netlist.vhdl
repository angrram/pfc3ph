...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_MNGR is
  port (
    ...
    \tmp_249_reg[0]_0\ : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \tmp_598_reg[0]_0\ : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \tmp_601_reg[0]_0\ : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \tmp_595_reg[0]_0\ : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \tmp_583_reg[0]_0\ : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \tmp_573_reg[0]_0\ : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \rd_182_reg_reg[0][0]_0\ : in STD_LOGIC_VECTOR ( 11 downto 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_MNGR is
  signal Delay11_out1_i_2_n_0 : STD_LOGIC;
  signal Delay11_out1_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of Delay11_out1_i_1 : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of Delay6_out1_i_1 : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of Delay7_out1_i_1 : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of Delay8_out1_i_1 : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of Delay8_out1_i_4 : label is "soft_lutpair21";
...
Delay11_out1_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
      ...
      I1 => nCS4,
      I2 => Delay11_out1_i_2_n_0,
      O => \^ncs4_1\
    );
Delay11_out1_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => Delay11_out1_i_3_n_0,
      I3 => is_SPI_MNGR_87(4),
      I4 => is_SPI_MNGR_87(3),
      I5 => is_SPI_MNGR_87(2),
      O => Delay11_out1_i_2_n_0
    );
Delay11_out1_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \tmp_985__0\,
      I5 => tmp_963,
      O => Delay11_out1_i_3_n_0
    );
Delay6_out1_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
      I0 => Delay8_out1_i_2_n_0,
      I1 => nCS3,
      I2 => Delay6_out1_i_2_n_0,
      O => \^ncs3_1\
    );
Delay6_out1_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000110000000F"
    )
        port map (
...
Delay6_out1_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFF0EFFFE0F0E0"
    )
        port map (
...
Delay7_out1_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
      I0 => Delay8_out1_i_2_n_0,
      I1 => nCS2,
      I2 => Delay7_out1_i_2_n_0,
      O => \^ncs2_1\
    );
Delay7_out1_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000110000000F"
    )
        port map (
...
Delay8_out1_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
Delay8_out1_i_3: unisim.vcomponents.LUT6
    generic map(
...
Delay8_out1_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
Delay8_out1_i_5: unisim.vcomponents.LUT6
    generic map(
...
u_SPI_MNGR: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_MNGR
     port map (
      Q(11 downto 0) => Delay_out1(11 downto 0),
      SCK_1 => SCK_1,
      SDI_1 => SDI_1,
      clk => clk,
      ...
      nCS4 => \^ncs4\,
      nCS4_1 => nCS4_1,
      \rd_182_reg_reg[0][0]_0\(11 downto 0) => Delay13_out1(11 downto 0),
      rst => rst,
      \tmp_249_reg[0]_0\(11 downto 0) => Delay1_out1(11 downto 0),
      \tmp_51_reg[0]_0\ => u_SPI_MNGR_n_2,
      \tmp_51_reg[0]_1\ => \tmp_51[0]_i_1_n_0\,
      \tmp_573_reg[0]_0\(11 downto 0) => Delay4_out1(11 downto 0),
      \tmp_583_reg[0]_0\(11 downto 0) => Delay12_out1(11 downto 0),
      \tmp_595_reg[0]_0\(11 downto 0) => Delay3_out1(11 downto 0),
      \tmp_598_reg[0]_0\(11 downto 0) => Delay2_out1(11 downto 0),
      \tmp_601_reg[0]_0\(11 downto 0) => Delay5_out1(11 downto 0),
