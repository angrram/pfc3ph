// -------------------------------------------------------------
// 
// File Name: hdl_prj2\hdlsrc\HDL_pfc_gold_fi\ShiftRegisterRAM_Wrapper_generic.v
...
// Source Path: HDL_pfc_gold_fi/simscape_system/FET_CTRL/ShiftRegisterRAM_Wrapper_generic
// Hierarchy Level: 4
// Model version: 1.167
// 
// -------------------------------------------------------------
...
module ShiftRegisterRAM_Wrapper_generic
  ...
  wire bypass1_and;
  wire ram_is_down3;
  reg [DataWidth - 1:0] wr_din_last_value;  // ufix6
  wire [DataWidth - 1:0] wr_din_1;  // ufix6
  reg [AddrWidth - 1:0] wr_addr_last_value;  // ufix3
  wire [AddrWidth - 1:0] wr_addr_1;  // ufix3
  reg  wr_en_last_value;  // ufix1
  wire wr_en_1;  // ufix1
  reg [AddrWidth - 1:0] rd_addr_last_value;  // ufix3
  wire [AddrWidth - 1:0] rd_addr_1;  // ufix3
  wire [DataWidth - 1:0] dout_1;  // ufix6
  wire ram_is_down4;
  reg [DataWidth - 1:0] dout_last_value;  // ufix6
  wire [DataWidth - 1:0] dout_bypass_1;  // ufix6
  reg [DataWidth - 1:0] dout_bypass_last_value;  // ufix6
  wire [DataWidth - 1:0] dout_bypass_bypass;  // ufix6
