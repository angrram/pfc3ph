// -------------------------------------------------------------
// 
// File Name: hdl_prj2\hdlsrc\HDL_pfc_gold_fi\dot_product_6.v
...
// Source Path: HDL_pfc_gold_fi/simscape_system/HDL Subsystem/Fixed-Point State-Space/hNNewMatrixA/dot_product_6
// Hierarchy Level: 3
// Model version: 1.167
// 
// -------------------------------------------------------------
...
module dot_product_6
  ...
  reg signed [24:0] HwModeRegister_reg [0:11];  // sfix25 [12]
  reg signed [24:0] HwModeRegister_reg_next [0:11];  // sfix25_En24 [12]
  reg signed [24:0] mul_in1_1 [0:5];  // sfix25_En24 [6]
  ...
  reg signed [49:0] sum_stage1_1_1;  // sfix50_En37
  ...
  reg signed [49:0] sum_stage1_2_1;  // sfix50_En37
  ...
  wire signed [49:0] rd_10_reg_next [0:1];  // sfix50_En37 [2]
  wire signed [49:0] sum_stage2_2;  // sfix50_En37
  ...
  always @(posedge clk)
    begin : HwModeRegister_process
      if (reset == 1'b1) begin
        for(HwModeRegister_t_1 = 32'sd0; HwModeRegister_t_1 <= 32'sd11; HwModeRegister_t_1 = HwModeRegister_t_1 + 32'sd1) begin
          HwModeRegister_reg[HwModeRegister_t_1] <= 25'sb0000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(HwModeRegister_t_0_1 = 32'sd0; HwModeRegister_t_0_1 <= 32'sd11; HwModeRegister_t_0_1 = HwModeRegister_t_0_1 + 32'sd1) begin
  ...
  always @* begin
    ...
    for(HwModeRegister_t_0_0 = 32'sd0; HwModeRegister_t_0_0 <= 32'sd5; HwModeRegister_t_0_0 = HwModeRegister_t_0_0 + 32'sd1) begin
      mul_in1_1[HwModeRegister_t_0_0] = HwModeRegister_reg[32'sd6 + HwModeRegister_t_0_0];
      HwModeRegister_reg_next[HwModeRegister_t_0_0] = mul_in1[HwModeRegister_t_0_0];
      HwModeRegister_reg_next[HwModeRegister_t_0_0 + 32'sd6] = HwModeRegister_reg[HwModeRegister_t_0_0];
    end
  ...
  assign sum_stage2_2 = rd_10_reg[1];
  assign rd_10_reg_next[0] = sum_stage1_3;
