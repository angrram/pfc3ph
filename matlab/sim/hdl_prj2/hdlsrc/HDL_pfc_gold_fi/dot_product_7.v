// -------------------------------------------------------------
// 
// File Name: hdl_prj2\hdlsrc\HDL_pfc_gold_fi\dot_product_7.v
...
// Source Path: HDL_pfc_gold_fi/simscape_system/HDL Subsystem/Fixed-Point State-Space/hNNewMatrixC/dot_product_7
// Hierarchy Level: 3
// Model version: 1.167
// 
// -------------------------------------------------------------
...
module dot_product_7
  ...
  reg signed [24:0] HwModeRegister_reg [0:13];  // sfix25 [14]
  reg signed [24:0] HwModeRegister_reg_next [0:13];  // sfix25_En20 [14]
  reg signed [24:0] mul_in1_1 [0:6];  // sfix25_En20 [7]
  ...
  reg signed [49:0] mul_out1_0_1;  // sfix50_En33
  wire signed [49:0] mul_out1_1_1;  // sfix50_En33
  reg signed [49:0] mul_out1_1_2;  // sfix50_En33
  wire signed [49:0] sum_stage1_1;  // sfix50_En33
  reg signed [49:0] sum_stage1_1_1;  // sfix50_En33
  wire signed [49:0] mul_out1_2;  // sfix50_En33
  reg signed [49:0] mul_out1_2_1;  // sfix50_En33
  wire signed [49:0] mul_out1_3;  // sfix50_En33
  reg signed [49:0] mul_out1_3_1;  // sfix50_En33
  wire signed [49:0] sum_stage1_2;  // sfix50_En33
  reg signed [49:0] sum_stage1_2_1;  // sfix50_En33
  wire signed [49:0] sum_stage2_1;  // sfix50_En33
  reg signed [49:0] sum_stage2_1_1;  // sfix50_En33
  wire signed [49:0] mul_out1_4;  // sfix50_En33
  reg signed [49:0] mul_out1_4_1;  // sfix50_En33
  wire signed [49:0] mul_out1_5;  // sfix50_En33
  reg signed [49:0] mul_out1_5_1;  // sfix50_En33
  wire signed [49:0] sum_stage1_3;  // sfix50_En33
  reg signed [49:0] sum_stage1_3_1;  // sfix50_En33
  wire signed [49:0] mul_out1_6;  // sfix50_En33
  reg signed [49:0] rd_11_reg [0:1];  // sfix50 [2]
  wire signed [49:0] rd_11_reg_next [0:1];  // sfix50_En33 [2]
  wire signed [49:0] sum_stage1_4;  // sfix50_En33
  wire signed [49:0] sum_stage2_2;  // sfix50_En33
  reg signed [49:0] sum_stage2_2_1;  // sfix50_En33
  ...
  always @(posedge clk)
    begin : HwModeRegister_process
      if (reset == 1'b1) begin
        for(HwModeRegister_t_1 = 32'sd0; HwModeRegister_t_1 <= 32'sd13; HwModeRegister_t_1 = HwModeRegister_t_1 + 32'sd1) begin
          HwModeRegister_reg[HwModeRegister_t_1] <= 25'sb0000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(HwModeRegister_t_0_1 = 32'sd0; HwModeRegister_t_0_1 <= 32'sd13; HwModeRegister_t_0_1 = HwModeRegister_t_0_1 + 32'sd1) begin
  ...
  always @* begin
    ...
    for(HwModeRegister_t_0_0 = 32'sd0; HwModeRegister_t_0_0 <= 32'sd6; HwModeRegister_t_0_0 = HwModeRegister_t_0_0 + 32'sd1) begin
      mul_in1_1[HwModeRegister_t_0_0] = HwModeRegister_reg[32'sd7 + HwModeRegister_t_0_0];
      HwModeRegister_reg_next[HwModeRegister_t_0_0] = mul_in1[HwModeRegister_t_0_0];
      HwModeRegister_reg_next[HwModeRegister_t_0_0 + 32'sd7] = HwModeRegister_reg[HwModeRegister_t_0_0];
    end
    ...
    begin : rd_11_process
      if (reset == 1'b1) begin
        for(rd_11_t_1 = 32'sd0; rd_11_t_1 <= 32'sd1; rd_11_t_1 = rd_11_t_1 + 32'sd1) begin
          rd_11_reg[rd_11_t_1] <= 50'sh0000000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  assign sum_stage1_4 = rd_11_reg[1];
  assign rd_11_reg_next[0] = mul_out1_6;
