// -------------------------------------------------------------
// 
// File Name: hdl_prj2\hdlsrc\HDL_pfc_gold_fi\simscape_system.v
...
// -- -------------------------------------------------------------
// Model base rate: 7.65404e-09
// Target subsystem base rate: 7.65404e-09
// Explicit user oversample request: 67x
// 
// 
...
// -- -------------------------------------------------------------
// O_Ia                          ce_out        7.65404e-09
// O_Ib                          ce_out        7.65404e-09
// O_Ic                          ce_out        7.65404e-09
// O_Vc                          ce_out        7.65404e-09
// O_Vb                          ce_out        7.65404e-09
// O_Va                          ce_out        7.65404e-09
// O_Vout                        ce_out        7.65404e-09
// O_I_load                      ce_out        7.65404e-09
// -- -------------------------------------------------------------
// 
// -------------------------------------------------------------
...
module simscape_system
  ...
  wire [7:0] real2uint8_out1;  // uint8
  wire [7:0] real2uint8_out2;  // uint8
  wire [7:0] real2uint8_out3;  // uint8
  wire [7:0] real2uint8_out4;  // uint8
  wire [7:0] real2uint8_out5;  // uint8
  wire [7:0] real2uint8_out6;  // uint8
  wire [7:0] real2uint8_out7;  // uint8
  wire [7:0] real2uint8_out8;  // uint8
  ...
  simscape_system_tc u_simscape_system_tc (.clk(clk),
                                           ...
                                           .enb(enb),
                                           .enb_1_1_1(enb_1_1_1),
                                           .enb_1_67_0(enb_1_67_0),
                                           .enb_1_67_1(enb_1_67_1)
                                           );
  ...
  //  count to value  = 66
  always @(posedge clk)
    begin : ctr_0_66_process
      if (reset == 1'b1) begin
        s <= 7'b0000000;
      end
      else begin
        if (enb) begin
          if (s >= 7'b1000010) begin
            s <= 7'b0000000;
          end
          else begin
            s <= s + 7'b0000001;
  ...
  real2uint8 u_real2uint8 (.clk(clk),
                           ...
                           .Vc(Vc_3),  // sfix18_En6
                           .Va(Va_3),  // sfix18_En6
                           .O_Ia(real2uint8_out1),  // uint8
                           .O_Ib(real2uint8_out2),  // uint8
                           .O_Ic(real2uint8_out3),  // uint8
                           .O_Vc(real2uint8_out4),  // uint8
                           .O_Vb(real2uint8_out5),  // uint8
                           .O_Va(real2uint8_out6),  // uint8
                           .O_Vout(real2uint8_out7),  // uint8
                           .O_I_load(real2uint8_out8)  // uint8
                           );
