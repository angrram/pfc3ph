// -------------------------------------------------------------
// 
// File Name: hdl_prj2\hdlsrc\HDL_pfc_gold_fi\hNNewMatrixA.v
...
// 
// Module: hNNewMatrixA
// Source Path: HDL_pfc_gold_fi/simscape_system/HDL Subsystem/Fixed-Point State-Space/hNNewMatrixA
// Hierarchy Level: 2
// Model version: 1.167
// 
// -------------------------------------------------------------
...
module hNNewMatrixA
  ...
  wire HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_8_0;
  reg  [5:0] rd_7_reg;  // ufix1 [6]
  wire HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_8_0_1;
  wire HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_0_6;
  reg  HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_0_6_1;
  wire enb_gated;
  ...
  wire signed [24:0] c0_serial_1 [0:41];  // sfix25_En13 [42]
  reg signed [24:0] c0_serial_1_1 [0:41];  // sfix25_En13 [42]
  ...
  reg signed [49:0] dot_product7_1;  // sfix50_En37
  ...
  wire HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_2_5;
  reg  [3:0] rd_5_reg;  // ufix1 [4]
  wire HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_2_5_1;
  wire enb_gated_1;
  ...
  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_8_0 = enb_counter == 7'b0001000;
  ...
  always @(posedge clk)
    begin : rd_7_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          rd_7_reg[0] <= HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_8_0;
          rd_7_reg[32'sd5:32'sd1] <= rd_7_reg[32'sd4:32'sd0];
        end
      end
    end

  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_8_0_1 = rd_7_reg[5];

  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_0_6 = enb_counter <= 7'b0000110;

  always @(posedge clk)
    begin : rd_0_process
      if (reset == 1'b1) begin
        HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_0_6_1 <= 1'b0;
      end
      else begin
        if (enb) begin
          HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_0_6_1 <= HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_0_6;
        end
      end
    end

  assign enb_gated = HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_0_6_1 && enb;
  ...
  assign configuration1[0] = 25'sb0100011110100110001100011;
  assign configuration1[1] = 25'sb1101110000101100111100010;
  assign configuration1[2] = 25'sb1101110000101100111100010;
  assign configuration1[3] = 25'sb1101110000101100111011001;
  assign configuration1[4] = 25'sb1101110000101100111011001;
  assign configuration1[5] = 25'sb0100011110100110001001110;
  assign configuration1[6] = 25'sb0000000000000000000000000;
  assign configuration1[7] = 25'sb1101110000101100111100010;
  assign configuration1[8] = 25'sb0100011110100110001100011;
  assign configuration1[9] = 25'sb1101110000101100111100010;
  assign configuration1[10] = 25'sb0100011110100110001001110;
  assign configuration1[11] = 25'sb1101110000101100111011001;
  assign configuration1[12] = 25'sb1101110000101100111011001;
  assign configuration1[13] = 25'sb0000000000000000000000000;
  assign configuration1[14] = 25'sb1101110000101100111100010;
  assign configuration1[15] = 25'sb1101110000101100111100010;
  assign configuration1[16] = 25'sb0100011110100110001100011;
  assign configuration1[17] = 25'sb1101110000101100111011001;
  assign configuration1[18] = 25'sb0100011110100110001001110;
  assign configuration1[19] = 25'sb1101110000101100111011001;
  assign configuration1[20] = 25'sb0000000000000000000000000;
  assign configuration1[21] = 25'sb1111100110001101001101010;
  assign configuration1[22] = 25'sb0000110011100101100101101;
  assign configuration1[23] = 25'sb1111100110001101001101010;
  assign configuration1[24] = 25'sb0000110011100101100110111;
  assign configuration1[25] = 25'sb1111100110001101001101000;
  assign configuration1[26] = 25'sb1111100110001101001101000;
  assign configuration1[27] = 25'sb0000000000000000000000000;
  assign configuration1[28] = 25'sb1111100110001101001101010;
  assign configuration1[29] = 25'sb1111100110001101001101010;
  assign configuration1[30] = 25'sb0000110011100101100101101;
  assign configuration1[31] = 25'sb1111100110001101001101000;
  assign configuration1[32] = 25'sb0000110011100101100110111;
  assign configuration1[33] = 25'sb1111100110001101001101000;
  assign configuration1[34] = 25'sb0000000000000000000000000;
  assign configuration1[35] = 25'sb0000110011100101100101101;
  assign configuration1[36] = 25'sb1111100110001101001101010;
  assign configuration1[37] = 25'sb1111100110001101001101010;
  assign configuration1[38] = 25'sb1111100110001101001101000;
  assign configuration1[39] = 25'sb1111100110001101001101000;
  assign configuration1[40] = 25'sb0000110011100101100110111;
  assign configuration1[41] = 25'sb0111111111111111000101001;
  ...
  assign c0_serial_1[5] = delayOutSignal_6;
  assign c0_serial_1[6] = delayOutSignal_0;
  assign c0_serial_1[7] = delayOutSignal_1;
  assign c0_serial_1[8] = delayOutSignal_2;
  assign c0_serial_1[9] = delayOutSignal_3;
  assign c0_serial_1[10] = delayOutSignal_4;
  assign c0_serial_1[11] = delayOutSignal_5;
  assign c0_serial_1[12] = delayOutSignal_0;
  assign c0_serial_1[13] = delayOutSignal_1;
  assign c0_serial_1[14] = delayOutSignal_2;
  assign c0_serial_1[15] = delayOutSignal_3;
  assign c0_serial_1[16] = delayOutSignal_4;
  assign c0_serial_1[17] = delayOutSignal_5;
  assign c0_serial_1[18] = delayOutSignal_0;
  assign c0_serial_1[19] = delayOutSignal_1;
  assign c0_serial_1[20] = delayOutSignal_2;
  assign c0_serial_1[21] = delayOutSignal_3;
  assign c0_serial_1[22] = delayOutSignal_4;
  assign c0_serial_1[23] = delayOutSignal_5;
  assign c0_serial_1[24] = delayOutSignal_0;
  assign c0_serial_1[25] = delayOutSignal_1;
  assign c0_serial_1[26] = delayOutSignal_2;
  assign c0_serial_1[27] = delayOutSignal_3;
  assign c0_serial_1[28] = delayOutSignal_4;
  assign c0_serial_1[29] = delayOutSignal_5;
  assign c0_serial_1[30] = delayOutSignal_0;
  assign c0_serial_1[31] = delayOutSignal_1;
  assign c0_serial_1[32] = delayOutSignal_2;
  assign c0_serial_1[33] = delayOutSignal_3;
  assign c0_serial_1[34] = delayOutSignal_4;
  assign c0_serial_1[35] = delayOutSignal_5;
  assign c0_serial_1[36] = delayOutSignal_0;
  assign c0_serial_1[37] = delayOutSignal_1;
  assign c0_serial_1[38] = delayOutSignal_2;
  assign c0_serial_1[39] = delayOutSignal_3;
  assign c0_serial_1[40] = delayOutSignal_4;
  assign c0_serial_1[41] = delayOutSignal_5;
  always @(posedge clk)
    begin : rd_1_process
      if (reset == 1'b1) begin
        for(rd_1_t_1 = 32'sd0; rd_1_t_1 <= 32'sd41; rd_1_t_1 = rd_1_t_1 + 32'sd1) begin
          c0_serial_1_1[rd_1_t_1] <= 25'sb0000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_1_t_0_0 = 32'sd0; rd_1_t_0_0 <= 32'sd41; rd_1_t_0_0 = rd_1_t_0_0 + 32'sd1) begin
  ...
  assign ratechange_splitcomp_out1_1[0] = c0_serial_1_1[6];
  assign ratechange_splitcomp_out1_1[1] = c0_serial_1_1[7];
  assign ratechange_splitcomp_out1_1[2] = c0_serial_1_1[8];
  assign ratechange_splitcomp_out1_1[3] = c0_serial_1_1[9];
  assign ratechange_splitcomp_out1_1[4] = c0_serial_1_1[10];
  assign ratechange_splitcomp_out1_1[5] = c0_serial_1_1[11];

  assign ratechange_splitcomp_out2_1[0] = c0_serial_1_1[12];
  assign ratechange_splitcomp_out2_1[1] = c0_serial_1_1[13];
  assign ratechange_splitcomp_out2_1[2] = c0_serial_1_1[14];
  assign ratechange_splitcomp_out2_1[3] = c0_serial_1_1[15];
  assign ratechange_splitcomp_out2_1[4] = c0_serial_1_1[16];
  assign ratechange_splitcomp_out2_1[5] = c0_serial_1_1[17];

  assign ratechange_splitcomp_out3_1[0] = c0_serial_1_1[18];
  assign ratechange_splitcomp_out3_1[1] = c0_serial_1_1[19];
  assign ratechange_splitcomp_out3_1[2] = c0_serial_1_1[20];
  assign ratechange_splitcomp_out3_1[3] = c0_serial_1_1[21];
  assign ratechange_splitcomp_out3_1[4] = c0_serial_1_1[22];
  assign ratechange_splitcomp_out3_1[5] = c0_serial_1_1[23];

  assign ratechange_splitcomp_out4_1[0] = c0_serial_1_1[24];
  assign ratechange_splitcomp_out4_1[1] = c0_serial_1_1[25];
  assign ratechange_splitcomp_out4_1[2] = c0_serial_1_1[26];
  assign ratechange_splitcomp_out4_1[3] = c0_serial_1_1[27];
  assign ratechange_splitcomp_out4_1[4] = c0_serial_1_1[28];
  assign ratechange_splitcomp_out4_1[5] = c0_serial_1_1[29];

  assign ratechange_splitcomp_out5_1[0] = c0_serial_1_1[30];
  assign ratechange_splitcomp_out5_1[1] = c0_serial_1_1[31];
  assign ratechange_splitcomp_out5_1[2] = c0_serial_1_1[32];
  assign ratechange_splitcomp_out5_1[3] = c0_serial_1_1[33];
  assign ratechange_splitcomp_out5_1[4] = c0_serial_1_1[34];
  assign ratechange_splitcomp_out5_1[5] = c0_serial_1_1[35];

  assign ratechange_splitcomp_out6_1[0] = c0_serial_1_1[36];
  assign ratechange_splitcomp_out6_1[1] = c0_serial_1_1[37];
  assign ratechange_splitcomp_out6_1[2] = c0_serial_1_1[38];
  assign ratechange_splitcomp_out6_1[3] = c0_serial_1_1[39];
  assign ratechange_splitcomp_out6_1[4] = c0_serial_1_1[40];
  assign ratechange_splitcomp_out6_1[5] = c0_serial_1_1[41];
  ...
  assign dot_product1 = (HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_8_0_1 == 1'b0 ? dot_product1_held :
              dot_product7_1);
  ...
  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_2_5 = enb_counter_ge_2_2 & enb_counter_le_7_2;
  ...
  always @(posedge clk)
    begin : rd_5_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          rd_5_reg[0] <= HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_2_5;
          rd_5_reg[32'sd3:32'sd1] <= rd_5_reg[32'sd2:32'sd0];
        end
      end
    end

  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_2_5_1 = rd_5_reg[3];

  assign enb_gated_1 = HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixA_shared_enb_phase_2_5_1 && enb;
  ...
  assign out_DTC2 = dot_product2[48:24] + $signed({1'b0, dot_product2[23]});
  always @(posedge clk)
  ...
  assign out_DTC3 = dot_product3[48:24] + $signed({1'b0, dot_product3[23]});
  always @(posedge clk)
  ...
  assign out_DTC4 = dot_product4[48:24] + $signed({1'b0, dot_product4[23]});
  always @(posedge clk)
  ...
  assign out_DTC5 = dot_product5[48:24] + $signed({1'b0, dot_product5[23]});
  always @(posedge clk)
    begin : rd_8_process
      if (reset == 1'b1) begin
  ...
  assign out_DTC6 = dot_product6[48:24] + $signed({1'b0, dot_product6[23]});
  always @(posedge clk)
    begin : rd_10_process
      if (reset == 1'b1) begin
  ...
  assign out_DTC7 = dot_product7_2[48:24] + $signed({1'b0, dot_product7_2[23]});
  always @(posedge clk)
    begin : rd_12_process
      if (reset == 1'b1) begin
