...
module hNNewMatrixB
  ...
  reg [2:0] rd_0_reg [0:4];  // ufix3 [5]
  reg [2:0] rd_0_reg_next [0:4];  // ufix3 [5]
  ...
  assign enb_gated = HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixB_shared_enb_phase_0_6 && enb;
  ...
  always @(posedge clk)
    begin : rd_0_process
      if (reset == 1'b1) begin
        for(rd_0_t_1 = 32'sd0; rd_0_t_1 <= 32'sd4; rd_0_t_1 = rd_0_t_1 + 32'sd1) begin
          rd_0_reg[rd_0_t_1] <= 3'b000;
        end
      end
      else begin
        if (enb) begin
          for(rd_0_t_0_1 = 32'sd0; rd_0_t_0_1 <= 32'sd4; rd_0_t_0_1 = rd_0_t_0_1 + 32'sd1) begin
  ...
  always @* begin
    counterSig_1 = rd_0_reg[4];
    rd_0_reg_next[0] = counterSig;

    for(rd_0_t_0_0 = 32'sd0; rd_0_t_0_0 <= 32'sd3; rd_0_t_0_0 = rd_0_t_0_0 + 32'sd1) begin
  ...
  assign dot_product1 = (HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixB_shared_enb_phase_13_0 == 1'b0 ? dot_product1_held :
              dot_product7);
  ...
  assign HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixB_shared_enb_phase_7_5 = enb_counter_ge_7_1 & enb_counter_le_12_1;

  assign enb_gated_1 = HDL_pfc_gold_fi_og_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixB_shared_enb_phase_7_5 && enb;
