...
module real2uint8
  ...
  output  [11:0] O_Ia;  // ufix12_E1
  output  [11:0] O_Ib;  // ufix12_E1
  output  [11:0] O_Ic;  // ufix12_E1
  output  [11:0] O_Vc;  // ufix12_E1
  output  [11:0] O_Vb;  // ufix12_E1
  output  [11:0] O_Va;  // ufix12_E1
  output  [11:0] O_Vout;  // ufix12_E1
  output  [11:0] O_I_load;  // ufix12_E1
  ...
  reg signed [18:0] Delay2_bypass_reg [0:2];  // sfix19 [3]
  reg signed [18:0] Delay2_bypass_reg_next [0:2];  // sfix19_En6 [3]
  ...
  reg signed [37:0] rd_3_reg [0:5];  // sfix38 [6]
  reg signed [37:0] rd_3_reg_next [0:5];  // sfix38_En18 [6]
  reg signed [37:0] Gain2_out1_1 [0:2];  // sfix38_En18 [3]
  reg signed [37:0] Delay_bypass_reg [0:2];  // sfix38 [3]
  reg signed [37:0] Delay_bypass_reg_next [0:2];  // sfix38_En18 [3]
  reg signed [37:0] Delay_out1 [0:2];  // sfix38_En18 [3]
  wire signed [37:0] Delay_out1_1 [0:2];  // sfix38_En18 [3]
  wire [11:0] Data_Type_Conversion5_out1 [0:2];  // ufix12_E1 [3]
  reg [11:0] Data_Type_Conversion5_out1_1 [0:2];  // ufix12_E1 [3]
  reg [11:0] Delay1_bypass_reg [0:2];  // ufix12 [3]
  reg [11:0] Delay1_bypass_reg_next [0:2];  // ufix12_E1 [3]
  reg [11:0] Delay1_out1 [0:2];  // ufix12_E1 [3]
  ...
  reg signed [37:0] rd_8_reg [0:5];  // sfix38 [6]
  reg signed [37:0] rd_8_reg_next [0:5];  // sfix38_En21 [6]
  reg signed [37:0] Gain5_out1_1 [0:2];  // sfix38_En21 [3]
  reg signed [37:0] Delay22_bypass_reg [0:2];  // sfix38 [3]
  reg signed [37:0] Delay22_bypass_reg_next [0:2];  // sfix38_En21 [3]
  reg signed [37:0] Delay22_out1 [0:2];  // sfix38_En21 [3]
  wire signed [37:0] Delay22_out1_1 [0:2];  // sfix38_En21 [3]
  wire [11:0] Data_Type_Conversion2_out1 [0:2];  // ufix12_E1 [3]
  reg [11:0] Data_Type_Conversion2_out1_1 [0:2];  // ufix12_E1 [3]
  reg [11:0] Delay24_bypass_reg [0:2];  // ufix12 [3]
  reg [11:0] Delay24_bypass_reg_next [0:2];  // ufix12_E1 [3]
  reg [11:0] Delay24_out1 [0:2];  // ufix12_E1 [3]
  ...
  reg signed [35:0] rd_11_reg [0:1];  // sfix36 [2]
  wire signed [35:0] rd_11_reg_next [0:1];  // sfix36_En20 [2]
  wire signed [35:0] Gain4_out1_1;  // sfix36_En20
  reg signed [35:0] Delay12_bypass_reg;  // sfix36
  wire signed [35:0] Delay12_out1;  // sfix36_En20
  wire signed [35:0] Delay12_out1_1;  // sfix36_En20
  wire [11:0] Data_Type_Conversion3_out1;  // ufix12_E1
  reg [11:0] Data_Type_Conversion3_out1_1;  // ufix12_E1
  reg [11:0] Delay25_bypass_reg;  // ufix12
  wire [11:0] Delay25_out1;  // ufix12_E1
  ...
  reg signed [35:0] rd_14_reg [0:1];  // sfix36 [2]
  wire signed [35:0] rd_14_reg_next [0:1];  // sfix36_En15 [2]
  ...
  wire [11:0] Data_Type_Conversion1_out1;  // ufix12_E1
  reg [11:0] Data_Type_Conversion1_out1_1;  // ufix12_E1
  reg [11:0] Delay29_bypass_reg;  // ufix12
  wire [11:0] Delay29_out1;  // ufix12_E1
  ...
  reg signed [31:0] rd_3_t_0_1;  // int32
  ...
  generate
    for(t_0_04 = 32'sd0; t_0_04 <= 32'sd2; t_0_04 = t_0_04 + 32'sd1) begin:Add2_out1_gen
      ...
      assign Add2_out1[t_0_04] = Add2_u + Add2_add_cast[t_0_04];
    end
  endgenerate
  always @(posedge clk)
    begin : rd_2_process
      if (reset == 1'b1) begin
        for(rd_2_t_1 = 32'sd0; rd_2_t_1 <= 32'sd2; rd_2_t_1 = rd_2_t_1 + 32'sd1) begin
          Add2_out1_1[rd_2_t_1] <= 19'sb0000000000000000000;
        end
      end
      else begin
        if (enb) begin
    ...
    begin : Delay2_bypass_process
      if (reset == 1'b1) begin
        for(Delay2_bypass_t_1_0 = 32'sd0; Delay2_bypass_t_1_0 <= 32'sd2; Delay2_bypass_t_1_0 = Delay2_bypass_t_1_0 + 32'sd1) begin
          Delay2_bypass_reg[Delay2_bypass_t_1_0] <= 19'sb0000000000000000000;
        end
      end
      else begin
        if (enb_1_37_1) begin
    ...
    begin : HwModeRegister2_process
      if (reset == 1'b1) begin
        for(HwModeRegister2_t_1 = 32'sd0; HwModeRegister2_t_1 <= 32'sd2; HwModeRegister2_t_1 = HwModeRegister2_t_1 + 32'sd1) begin
          Delay2_out1_2[HwModeRegister2_t_1] <= 19'sb0000000000000000000;
        end
      end
      else begin
        if (enb) begin
    ...
    begin : rd_3_process
      if (reset == 1'b1) begin
        for(rd_3_t_1 = 32'sd0; rd_3_t_1 <= 32'sd5; rd_3_t_1 = rd_3_t_1 + 32'sd1) begin
          rd_3_reg[rd_3_t_1] <= 38'sh0000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_3_t_0_1 = 32'sd0; rd_3_t_0_1 <= 32'sd5; rd_3_t_0_1 = rd_3_t_0_1 + 32'sd1) begin
            rd_3_reg[rd_3_t_0_1] <= rd_3_reg_next[rd_3_t_0_1];
          end
        end
      end
    end
  ...
  always @* begin
    ...
    for(rd_3_t_0_0 = 32'sd0; rd_3_t_0_0 <= 32'sd2; rd_3_t_0_0 = rd_3_t_0_0 + 32'sd1) begin
      Gain2_out1_1[rd_3_t_0_0] = rd_3_reg[32'sd3 + rd_3_t_0_0];
      rd_3_reg_next[rd_3_t_0_0] = Gain2_out1[rd_3_t_0_0];
      rd_3_reg_next[rd_3_t_0_0 + 32'sd3] = rd_3_reg[rd_3_t_0_0];
    end
    ...
    begin : Delay_bypass_process
      if (reset == 1'b1) begin
        for(Delay_bypass_t_1_0 = 32'sd0; Delay_bypass_t_1_0 <= 32'sd2; Delay_bypass_t_1_0 = Delay_bypass_t_1_0 + 32'sd1) begin
          Delay_bypass_reg[Delay_bypass_t_1_0] <= 38'sh0000000000;
        end
      end
      else begin
        if (enb_1_37_1) begin
  ...
  always @* begin
    if (enb_1_37_1 == 1'b1) begin
      for(Delay_bypass_t_1 = 32'sd0; Delay_bypass_t_1 <= 32'sd2; Delay_bypass_t_1 = Delay_bypass_t_1 + 32'sd1) begin
        Delay_out1[Delay_bypass_t_1] = Gain2_out1_1[Delay_bypass_t_1];
      end
    end
    else begin
    ...
    for(Delay_bypass_t_2 = 32'sd0; Delay_bypass_t_2 <= 32'sd2; Delay_bypass_t_2 = Delay_bypass_t_2 + 32'sd1) begin
      Delay_bypass_reg_next[Delay_bypass_t_2] = Gain2_out1_1[Delay_bypass_t_2];
    end
  ...
  genvar ii2;
  generate
    for(ii2 = 32'sd0; ii2 <= 32'sd2; ii2 = ii2 + 32'sd1) begin:Data_Type_Conversion5_out1_gen
      assign Data_Type_Conversion5_out1[ii2] = Delay_out1_1[ii2][30:19];
    end
  endgenerate
  always @(posedge clk)
    begin : rd_4_process
      if (reset == 1'b1) begin
        for(rd_4_t_1 = 32'sd0; rd_4_t_1 <= 32'sd2; rd_4_t_1 = rd_4_t_1 + 32'sd1) begin
          Data_Type_Conversion5_out1_1[rd_4_t_1] <= 12'b000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_4_t_0_0 = 32'sd0; rd_4_t_0_0 <= 32'sd2; rd_4_t_0_0 = rd_4_t_0_0 + 32'sd1) begin
            Data_Type_Conversion5_out1_1[rd_4_t_0_0] <= Data_Type_Conversion5_out1[rd_4_t_0_0];
          end
        end
      end
    end
    ...
    begin : Delay1_bypass_process
      if (reset == 1'b1) begin
        for(Delay1_bypass_t_1_0 = 32'sd0; Delay1_bypass_t_1_0 <= 32'sd2; Delay1_bypass_t_1_0 = Delay1_bypass_t_1_0 + 32'sd1) begin
          Delay1_bypass_reg[Delay1_bypass_t_1_0] <= 12'b000000000000;
        end
      end
      else begin
        if (enb_1_37_1) begin
    ...
    begin : rd_5_process
      if (reset == 1'b1) begin
        for(rd_5_t_1 = 32'sd0; rd_5_t_1 <= 32'sd2; rd_5_t_1 = rd_5_t_1 + 32'sd1) begin
          Mux_out1_1[rd_5_t_1] <= 18'sb000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_5_t_0_0 = 32'sd0; rd_5_t_0_0 <= 32'sd2; rd_5_t_0_0 = rd_5_t_0_0 + 32'sd1) begin
            Mux_out1_1[rd_5_t_0_0] <= Mux_out1[rd_5_t_0_0];
          end
        end
      end
    end
    ...
    begin : rd_6_process
      if (reset == 1'b1) begin
        for(rd_6_t_1 = 32'sd0; rd_6_t_1 <= 32'sd2; rd_6_t_1 = rd_6_t_1 + 32'sd1) begin
          Delay8_out1_2[rd_6_t_1] <= 18'sb000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_6_t_0_0 = 32'sd0; rd_6_t_0_0 <= 32'sd2; rd_6_t_0_0 = rd_6_t_0_0 + 32'sd1) begin
            Delay8_out1_2[rd_6_t_0_0] <= Delay8_out1_1[rd_6_t_0_0];
          end
        end
      end
    end
    ...
    begin : rd_7_process
      if (reset == 1'b1) begin
        for(rd_7_t_1 = 32'sd0; rd_7_t_1 <= 32'sd2; rd_7_t_1 = rd_7_t_1 + 32'sd1) begin
          Add3_out1_1[rd_7_t_1] <= 19'sb0000000000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_7_t_0_0 = 32'sd0; rd_7_t_0_0 <= 32'sd2; rd_7_t_0_0 = rd_7_t_0_0 + 32'sd1) begin
            Add3_out1_1[rd_7_t_0_0] <= Add3_out1[rd_7_t_0_0];
          end
        end
      end
    end
  ...
  always @(posedge clk)
    begin : rd_8_process
      if (reset == 1'b1) begin
        for(rd_8_t_1 = 32'sd0; rd_8_t_1 <= 32'sd5; rd_8_t_1 = rd_8_t_1 + 32'sd1) begin
          rd_8_reg[rd_8_t_1] <= 38'sh0000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_8_t_0_1 = 32'sd0; rd_8_t_0_1 <= 32'sd5; rd_8_t_0_1 = rd_8_t_0_1 + 32'sd1) begin
  ...
  always @* begin
    ...
    for(rd_8_t_0_0 = 32'sd0; rd_8_t_0_0 <= 32'sd2; rd_8_t_0_0 = rd_8_t_0_0 + 32'sd1) begin
      Gain5_out1_1[rd_8_t_0_0] = rd_8_reg[32'sd3 + rd_8_t_0_0];
      rd_8_reg_next[rd_8_t_0_0] = Gain5_out1[rd_8_t_0_0];
      rd_8_reg_next[rd_8_t_0_0 + 32'sd3] = rd_8_reg[rd_8_t_0_0];
    end
    ...
    begin : Delay22_bypass_process
      if (reset == 1'b1) begin
        for(Delay22_bypass_t_1_0 = 32'sd0; Delay22_bypass_t_1_0 <= 32'sd2; Delay22_bypass_t_1_0 = Delay22_bypass_t_1_0 + 32'sd1) begin
          Delay22_bypass_reg[Delay22_bypass_t_1_0] <= 38'sh0000000000;
        end
      end
      else begin
        if (enb_1_37_1) begin
  ...
  always @* begin
    if (enb_1_37_1 == 1'b1) begin
      for(Delay22_bypass_t_1 = 32'sd0; Delay22_bypass_t_1 <= 32'sd2; Delay22_bypass_t_1 = Delay22_bypass_t_1 + 32'sd1) begin
        Delay22_out1[Delay22_bypass_t_1] = Gain5_out1_1[Delay22_bypass_t_1];
      end
    end
    else begin
    ...
    for(Delay22_bypass_t_2 = 32'sd0; Delay22_bypass_t_2 <= 32'sd2; Delay22_bypass_t_2 = Delay22_bypass_t_2 + 32'sd1) begin
      Delay22_bypass_reg_next[Delay22_bypass_t_2] = Gain5_out1_1[Delay22_bypass_t_2];
    end
  ...
  generate
    for(ii11 = 32'sd0; ii11 <= 32'sd2; ii11 = ii11 + 32'sd1) begin:Data_Type_Conversion2_out1_gen
      assign Data_Type_Conversion2_out1[ii11] = Delay22_out1_1[ii11][33:22];
    end
  endgenerate
  always @(posedge clk)
    begin : rd_9_process
      if (reset == 1'b1) begin
        for(rd_9_t_1 = 32'sd0; rd_9_t_1 <= 32'sd2; rd_9_t_1 = rd_9_t_1 + 32'sd1) begin
          Data_Type_Conversion2_out1_1[rd_9_t_1] <= 12'b000000000000;
        end
      end
      else begin
        if (enb) begin
          for(rd_9_t_0_0 = 32'sd0; rd_9_t_0_0 <= 32'sd2; rd_9_t_0_0 = rd_9_t_0_0 + 32'sd1) begin
            Data_Type_Conversion2_out1_1[rd_9_t_0_0] <= Data_Type_Conversion2_out1[rd_9_t_0_0];
          end
        end
      end
    end
    ...
    begin : Delay24_bypass_process
      if (reset == 1'b1) begin
        for(Delay24_bypass_t_1_0 = 32'sd0; Delay24_bypass_t_1_0 <= 32'sd2; Delay24_bypass_t_1_0 = Delay24_bypass_t_1_0 + 32'sd1) begin
          Delay24_bypass_reg[Delay24_bypass_t_1_0] <= 12'b000000000000;
        end
      end
      else begin
        if (enb_1_37_1) begin
  ...
  always @* begin
    if (enb_1_37_1 == 1'b1) begin
      for(Delay24_bypass_t_1 = 32'sd0; Delay24_bypass_t_1 <= 32'sd2; Delay24_bypass_t_1 = Delay24_bypass_t_1 + 32'sd1) begin
        Delay24_out1[Delay24_bypass_t_1] = Data_Type_Conversion2_out1_1[Delay24_bypass_t_1];
      end
    end
    else begin
    ...
    for(Delay24_bypass_t_2 = 32'sd0; Delay24_bypass_t_2 <= 32'sd2; Delay24_bypass_t_2 = Delay24_bypass_t_2 + 32'sd1) begin
      Delay24_bypass_reg_next[Delay24_bypass_t_2] = Data_Type_Conversion2_out1_1[Delay24_bypass_t_2];
    end
    ...
    begin : rd_11_process
      if (reset == 1'b1) begin
        for(rd_11_t_1 = 32'sd0; rd_11_t_1 <= 32'sd1; rd_11_t_1 = rd_11_t_1 + 32'sd1) begin
          rd_11_reg[rd_11_t_1] <= 36'sh000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  assign Gain4_out1_1 = rd_11_reg[1];
  assign rd_11_reg_next[0] = Gain4_out1;
  assign rd_11_reg_next[1] = rd_11_reg[0];

  always @(posedge clk)
    begin : Delay12_bypass_process
      if (reset == 1'b1) begin
        Delay12_bypass_reg <= 36'sh000000000;
      end
      else begin
        if (enb_1_37_1) begin
          Delay12_bypass_reg <= Gain4_out1_1;
        end
      end
    end

  assign Delay12_out1 = (enb_1_37_1 == 1'b1 ? Gain4_out1_1 :
              Delay12_bypass_reg);

  assign Delay12_out1_1 = Delay12_out1;

  assign Data_Type_Conversion3_out1 = Delay12_out1_1[32:21];
  always @(posedge clk)
    begin : rd_12_process
      if (reset == 1'b1) begin
        Data_Type_Conversion3_out1_1 <= 12'b000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : Delay25_bypass_process
      if (reset == 1'b1) begin
        Delay25_bypass_reg <= 12'b000000000000;
      end
      else begin
        if (enb_1_37_1) begin
          Delay25_bypass_reg <= Data_Type_Conversion3_out1_1;
        end
      end
    end

  assign Delay25_out1 = (enb_1_37_1 == 1'b1 ? Data_Type_Conversion3_out1_1 :
              Delay25_bypass_reg);
    ...
    begin : rd_14_process
      if (reset == 1'b1) begin
        for(rd_14_t_1 = 32'sd0; rd_14_t_1 <= 32'sd1; rd_14_t_1 = rd_14_t_1 + 32'sd1) begin
          rd_14_reg[rd_14_t_1] <= 36'sh000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  assign Gain3_out1_1 = rd_14_reg[1];
  assign rd_14_reg_next[0] = Gain3_out1;
  ...
  assign Delay16_out1 = (enb_1_37_1 == 1'b1 ? Gain3_out1_1 :
              Delay16_bypass_reg);

  assign Delay16_out1_1 = Delay16_out1;

  assign Data_Type_Conversion1_out1 = Delay16_out1_1[27:16];
  always @(posedge clk)
    begin : rd_15_process
      if (reset == 1'b1) begin
        Data_Type_Conversion1_out1_1 <= 12'b000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : Delay29_bypass_process
      if (reset == 1'b1) begin
        Delay29_bypass_reg <= 12'b000000000000;
      end
      else begin
        if (enb_1_37_1) begin
          Delay29_bypass_reg <= Data_Type_Conversion1_out1_1;
        end
      end
    end

  assign Delay29_out1 = (enb_1_37_1 == 1'b1 ? Data_Type_Conversion1_out1_1 :
              Delay29_bypass_reg);
