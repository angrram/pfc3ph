...
HD_PWD='C:/Users/Angel/Desktop/hil/pfc3ph/matlab/sim/hdl_prj2/vivado_prj/simscape_system_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simscape_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simscape_system.tcl
