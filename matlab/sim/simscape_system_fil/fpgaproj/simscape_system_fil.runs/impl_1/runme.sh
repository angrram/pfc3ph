...
HD_PWD='C:/Users/Angel/Desktop/hil/pfc3ph/matlab/sim/simscape_system_fil/fpgaproj/simscape_system_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simscape_system_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simscape_system_fil.tcl -notrace
