...
HD_PWD='C:/Users/Angel/Desktop/hil/pfc3ph/matlab/sim/simscape_system_fil/fpgaproj/simscape_system_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simscape_system_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simscape_system_fil.tcl
