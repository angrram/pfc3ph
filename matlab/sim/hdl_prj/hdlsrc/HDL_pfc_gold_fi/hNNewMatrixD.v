// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HDL_pfc_gold_fi\hNNewMatrixD.v
...
module hNNewMatrixD
  ...
  wire HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_26_0;
  ...
  wire HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_7_18;
  wire enb_gated_1;
  ...
  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_26_0 = enb_counter == 6'b011010;

  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_0_19 = enb_counter <= 6'b010011;

  assign enb_gated = HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_0_19 && enb;
  ...
  always @(posedge clk)
    begin : delayMatch_wr_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (delayMatch_waddr >= 3'b010) begin
            delayMatch_waddr <= 3'b000;
          end
          else begin
  ...
  always @(posedge clk)
    begin : delayMatch_rd_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (delayMatch_raddr >= 3'b010) begin
  ...
  assign dot_product1 = (HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_26_0 == 1'b0 ? dot_product1_held :
              dot_product20);
  ...
  assign HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_7_18 = enb_counter_ge_7_1 & enb_counter_le_25_1;

  assign enb_gated_1 = HDL_pfc_gold_fi_simscape_system_HDL_Subsystem_Fixed_Point_State_Space_hNNewMatrixD_shared_enb_phase_7_18 && enb;
