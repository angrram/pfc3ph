// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HDL_pfc_gold_fi\dot_product_6.v
...
module dot_product_6
  ...
  always @(posedge clk)
    begin : HwModeRegister5_wr_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (HwModeRegister5_waddr >= 3'b100) begin
            HwModeRegister5_waddr <= 3'b000;
          end
          else begin
  ...
  always @(posedge clk)
    begin : HwModeRegister5_rd_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (HwModeRegister5_raddr >= 3'b100) begin
  ...
  // <S5>/Fixed-Point State-Space
  // <S5>/Fixed-Point State-Space
  assign sum_stage3_1 = sum_stage2_1 + sum_stage1_3;
