// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HDL_pfc_gold_fi\FET_CTRL.v
...
module FET_CTRL
  ...
  reg signed [17:0] Discrete_Time_Integrator_u_sat_1 [0:4];  // sfix18_En8 [5]
  ...
  wire signed [17:0] ic;  // sfix18_En8
  ...
  wire signed [17:0] Discrete_Time_Integrator_add_in;  // sfix18_En8
  reg signed [17:0] tapped_delay_reg [0:4];  // sfix18 [5]
  reg signed [17:0] tapped_delay_reg_next [0:4];  // sfix18_En8 [5]
  wire signed [17:0] Discrete_Time_Integrator_u_sat_3 [0:4];  // sfix18_En8 [5]
  reg signed [17:0] Discrete_Time_Integrator_u_sat_held_1 [0:4];  // sfix18_En8 [5]
  wire signed [17:0] Discrete_Time_Integrator_u_sat_4 [0:5];  // sfix18_En8 [6]
  ...
  assign G_unbuffer = (counterSig == 3'b000 ? G_0_1 :
              (counterSig == 3'b001 ? G_1_1 :
              (counterSig == 3'b010 ? G_2_1 :
              (counterSig == 3'b011 ? G_3_1 :
              (counterSig == 3'b100 ? G_4_1 :
              G_5_1)))));

  assign mergedInput = {G_unbuffer, counterSig, counterSig};
  ...
  assign slicedInput = mergedOutput[5:3];
  ...
  assign slicedInput_1 = mergedOutput[2:0];
  ...
  assign slicedInput_2 = mergedOutput[6];
  ...
  assign Multiply_Add_out1 = Multiply_Add_add_add_temp[17:0];
  ...
  assign mergedInput_1 = {Discrete_Time_Integrator_x_reg_unbuffer, Discrete_Time_Integrator_x_reg_unbuffer};
  ...
  assign Discrete_Time_Integrator_add_in = slicedInput_4;
  ...
  always @* begin
    ...
    for(tapped_delay_t_0_0 = 32'sd0; tapped_delay_t_0_0 <= 32'sd4; tapped_delay_t_0_0 = tapped_delay_t_0_0 + 32'sd1) begin
      Discrete_Time_Integrator_u_sat_2[tapped_delay_t_0_0] = tapped_delay_reg[tapped_delay_t_0_0];
    end
    ...
    tapped_delay_reg_next[4] = Discrete_Time_Integrator_u_add;
  end

  assign Discrete_Time_Integrator_u_sat_3[0] = Discrete_Time_Integrator_u_sat_2[0];
  assign Discrete_Time_Integrator_u_sat_3[1] = Discrete_Time_Integrator_u_sat_2[1];
  assign Discrete_Time_Integrator_u_sat_3[2] = Discrete_Time_Integrator_u_sat_2[2];
  assign Discrete_Time_Integrator_u_sat_3[3] = Discrete_Time_Integrator_u_sat_2[3];
  assign Discrete_Time_Integrator_u_sat_3[4] = Discrete_Time_Integrator_u_sat_2[4];
      ...
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          for(Discrete_Time_Integrator_u_sat_state_t_0_0 = 32'sd0; Discrete_Time_Integrator_u_sat_state_t_0_0 <= 32'sd4; Discrete_Time_Integrator_u_sat_state_t_0_0 = Discrete_Time_Integrator_u_sat_state_t_0_0 + 32'sd1) begin
            Discrete_Time_Integrator_u_sat_held_1[Discrete_Time_Integrator_u_sat_state_t_0_0] <= Discrete_Time_Integrator_u_sat_1[Discrete_Time_Integrator_u_sat_state_t_0_0];
          end
        end
      end
    end
  ...
  always @* begin
    if (crp_temp_streamed_enb_phase_0_0 == 1'b0) begin
      for(Discrete_Time_Integrator_u_sat_enb_t_1 = 32'sd0; Discrete_Time_Integrator_u_sat_enb_t_1 <= 32'sd4; Discrete_Time_Integrator_u_sat_enb_t_1 = Discrete_Time_Integrator_u_sat_enb_t_1 + 32'sd1) begin
        Discrete_Time_Integrator_u_sat_1[Discrete_Time_Integrator_u_sat_enb_t_1] = Discrete_Time_Integrator_u_sat_held_1[Discrete_Time_Integrator_u_sat_enb_t_1];
      end
    end
    else begin
      for(Discrete_Time_Integrator_u_sat_enb_t_0_0 = 32'sd0; Discrete_Time_Integrator_u_sat_enb_t_0_0 <= 32'sd4; Discrete_Time_Integrator_u_sat_enb_t_0_0 = Discrete_Time_Integrator_u_sat_enb_t_0_0 + 32'sd1) begin
        Discrete_Time_Integrator_u_sat_1[Discrete_Time_Integrator_u_sat_enb_t_0_0] = Discrete_Time_Integrator_u_sat_3[Discrete_Time_Integrator_u_sat_enb_t_0_0];
      end
    end
  end

  assign Discrete_Time_Integrator_u_sat_4[0] = Discrete_Time_Integrator_u_sat_1[0];
  assign Discrete_Time_Integrator_u_sat_4[1] = Discrete_Time_Integrator_u_sat_1[1];
  assign Discrete_Time_Integrator_u_sat_4[2] = Discrete_Time_Integrator_u_sat_1[2];
  assign Discrete_Time_Integrator_u_sat_4[3] = Discrete_Time_Integrator_u_sat_1[3];
  assign Discrete_Time_Integrator_u_sat_4[4] = Discrete_Time_Integrator_u_sat_1[4];
  assign Discrete_Time_Integrator_u_sat_4[5] = Discrete_Time_Integrator_u_sat;
  ...
  always @* begin
    if (enb_1_37_1 == 1'b1) begin
      for(Discrete_Time_Integrator_reg_bypass_t_1 = 32'sd0; Discrete_Time_Integrator_reg_bypass_t_1 <= 32'sd5; Discrete_Time_Integrator_reg_bypass_t_1 = Discrete_Time_Integrator_reg_bypass_t_1 + 32'sd1) begin
        Discrete_Time_Integrator_x_reg[Discrete_Time_Integrator_reg_bypass_t_1] = Discrete_Time_Integrator_u_sat_4[Discrete_Time_Integrator_reg_bypass_t_1];
      end
    end
    else begin
    ...
    for(Discrete_Time_Integrator_reg_bypass_t_2 = 32'sd0; Discrete_Time_Integrator_reg_bypass_t_2 <= 32'sd5; Discrete_Time_Integrator_reg_bypass_t_2 = Discrete_Time_Integrator_reg_bypass_t_2 + 32'sd1) begin
      Discrete_Time_Integrator_reg_bypass_reg_next[Discrete_Time_Integrator_reg_bypass_t_2] = Discrete_Time_Integrator_u_sat_4[Discrete_Time_Integrator_reg_bypass_t_2];
    end
