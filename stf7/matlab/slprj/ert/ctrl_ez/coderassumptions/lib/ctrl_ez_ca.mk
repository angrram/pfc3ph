###########################################################################
## Makefile generated for component 'ctrl_ez_ca'. 
## 
## Makefile     : ctrl_ez_ca.mk
## Generated on : Sun May 11 12:01:12 2025
## Final product: ./ctrl_ez_ca.lib
...
COMPILER_COMMAND_FILE     = ctrl_ez_ca_comp.rsp
CMD_FILE                  = ctrl_ez_ca.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = ctrl_ez_ca.lib
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/ctrl_ez_ca.c
...
OBJS = coder_assumptions_hwimpl.o coder_assumptions_flt.o ctrl_ez_ca.o
...
CPP_LDFLAGS_SKIPFORSIL = --specs=nano.specs
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = --specs=nano.specs
...
LDFLAGS_SKIPFORSIL = --specs=nano.specs
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = --specs=nano.specs
...
%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/lib/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/lib/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/lib/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ctrl_ez_ca.o : $(START_DIR)/slprj/ert/ctrl_ez/coderassumptions/ctrl_ez_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"
