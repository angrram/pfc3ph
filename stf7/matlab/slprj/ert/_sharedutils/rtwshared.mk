...
## Generated on : Sun May 11 11:58:40 2025
...
SRCS = $(START_DIR)/slprj/ert/_sharedutils/const_params.c $(START_DIR)/slprj/ert/_sharedutils/intrp1d_fu32fl.c $(START_DIR)/slprj/ert/_sharedutils/plook_u32ff_evenc.c
...
intrp1d_fu32fl.o : $(START_DIR)/slprj/ert/_sharedutils/intrp1d_fu32fl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


plook_u32ff_evenc.o : $(START_DIR)/slprj/ert/_sharedutils/plook_u32ff_evenc.c
	$(CC) $(CFLAGS) -o "$@" "$<"
