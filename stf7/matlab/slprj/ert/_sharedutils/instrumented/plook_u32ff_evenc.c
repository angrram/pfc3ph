...
# 18 "plook_u32ff_evenc.c"
uint32_t plook_u32ff_evenc(float u, float bp0, float bpSpace, uint32_t maxIndex, float *
fraction) 
{ 
uint32_t bpIndex; 
# 20
stackStart_rtwshared(2U); { 
# 30
if (u <= bp0) { 
bpIndex = (0U); 
*fraction = (0.0F); 
...
stackEnd_rtwshared(2U); return bpIndex; 
} 
