...
## 
## Makefile     : ctrl_ez.mk
## Generated on : Sun May 18 12:03:04 2025
...
START_DIR                 = C:/Users/Angel/Desktop/hil/pfc3ph/stf7/matlab/ctrl_ez
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SRCS = $(START_DIR)/ARMCortex-M/_ref/ctrl_ez/ctrl_ez.c
...
%.o : $(START_DIR)/ARMCortex-M/_ref/ctrl_ez/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ARMCortex-M/_ref/ctrl_ez/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ARMCortex-M/_ref/ctrl_ez/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ARMCortex-M/_ref/ctrl_ez/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ARMCortex-M/_ref/ctrl_ez/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ctrl_ez.o : $(START_DIR)/ARMCortex-M/_ref/ctrl_ez/ctrl_ez.c
	$(CC) $(CFLAGS) -o "$@" "$<"
