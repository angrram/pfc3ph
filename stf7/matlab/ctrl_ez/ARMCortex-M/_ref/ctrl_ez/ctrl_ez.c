 ...
 *    'alpha_sogi' (':2177:2')
 */
void ctrl_ez_alpha_sogi(float rtu_v_ct_alpha, float rtu_v_ct_alpha_k_1, float
  rtu_v_ct_alpha_k_2, float rtu_vd_sogi_alpha_k_1, float rtu_vd_sogi_alpha_k_2,
...
void ctrl_ez_Init(float *rty_Qa)
{
  ...
  /* InitializeConditions for DiscreteIntegrator: 'Integrator1' (':2274') incorporates:
   *  Constant: 'Constant2' (':2271')
   */
...
void ctrl_ez_trigger_ctrl_ez(const float *rtu_ia, const float *rtu_ib, const
  float *rtu_ic, const float *rtu_ov_out, const float *rtu_va, const float
  ...
  bool *rty_lock)
{
  ...
  ctrl_ez_alpha_sogi(rtb_Kalphabeta0_idx_0, ctrl_ez_DW.Memory4_PreviousInput_f,
                     ...
                     ctrl_ez_DW.Memory3_PreviousInput_n,
                     ctrl_ez_DW.Memory8_PreviousInput,
                     ctrl_ez_DW.Integrator1_DSTATE, &rtb_vd_sogi_alpha,
                     &rtb_vq_sogi_alpha);
  ...
  ctrl_ez_alpha_sogi(rtb_Gain_l_idx_2, ctrl_ez_DW.Memory10_PreviousInput,
                     ...
                     ctrl_ez_DW.Memory9_PreviousInput,
                     ctrl_ez_DW.Memory12_PreviousInput,
                     ctrl_ez_DW.Integrator1_DSTATE, &rtb_vd_sogi_alpha_m,
                     &rtb_vq_sogi_alpha_p);
   ...
   *  Memory: 'Memory4' (':2294')
   */
  rtb_Switch1_idx_0 = ctrl_ez_DW.Memory2_PreviousInput * rtb_Saturation *
    0.000125F + ctrl_ez_DW.Memory3_PreviousInput;
  ...
  rtb_Switch1_idx_0 = ctrl_ez_DW.Memory2_PreviousInput -
  ...
  *rty_Qa = ctrl_ez_DW.T2[0];
   ...
   *  Gain: 'Gain1' (':2272')
   */
  rtb_Saturation = (rtb_Saturation - ctrl_ez_DW.Integrator1_DSTATE) - 0.02F *
