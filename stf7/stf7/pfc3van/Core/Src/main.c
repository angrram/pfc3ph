...
uint32_t iac_data[3], dc_data[2], vac_data[1], vac_1_data[1];
uint32_t vacs[4];
/* USER CODE END 0 */
...
void SystemClock_Config(void) {
  ...
  LL_RCC_PLL_ConfigDomain_SYS(LL_RCC_PLLSOURCE_HSE, LL_RCC_PLLM_DIV_16, 192,
                              LL_RCC_PLLP_DIV_2);
  LL_RCC_PLL_Enable();
...
static void MX_ADC1_Init(void) {
  ...
  */
  ...
  LL_GPIO_Init(VDC_GPIO_Port, &GPIO_InitStruct);
  ...
  LL_DMA_ConfigAddresses(
      ...
      (uint32_t)&dc_data, LL_DMA_DIRECTION_PERIPH_TO_MEMORY);
  LL_DMA_SetDataLength(DMA2, LL_DMA_STREAM_0, (uint32_t)2);
...
static void MX_ADC3_Init(void) {
  ...
  */
  ...
  LL_DMA_ConfigAddresses(
      ...
      (uint32_t)&iac_data, LL_DMA_DIRECTION_PERIPH_TO_MEMORY);
  LL_DMA_SetDataLength(DMA2, LL_DMA_STREAM_1, (uint32_t)3);
  ...
  LL_ADC_SetChannelSamplingTime(ADC3, LL_ADC_CHANNEL_0,
                                LL_ADC_SAMPLINGTIME_144CYCLES);

  /** Configure Regular Channel
   */
  LL_ADC_REG_SetSequencerRanks(ADC3, LL_ADC_REG_RANK_2, LL_ADC_CHANNEL_5);
  LL_ADC_SetChannelSamplingTime(ADC3, LL_ADC_CHANNEL_5,
                                LL_ADC_SAMPLINGTIME_144CYCLES);

  /** Configure Regular Channel
   */
  LL_ADC_REG_SetSequencerRanks(ADC3, LL_ADC_REG_RANK_3, LL_ADC_CHANNEL_6);
  LL_ADC_SetChannelSamplingTime(ADC3, LL_ADC_CHANNEL_6,
                                LL_ADC_SAMPLINGTIME_144CYCLES);
...
static void MX_TIM1_Init(void) {
  ...
  /* TIM1 interrupt Init */
  NVIC_SetPriority(TIM1_TRG_COM_TIM11_IRQn,
  ...
  TIM_BDTRInitStruct.DeadTime = 19;
  ...
  PE13   ------> TIM1_CH3
  */
  GPIO_InitStruct.Pin = DW_L3_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(DW_L3_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = DW_L1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(DW_L1_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = UP_L1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(UP_L1_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = DW_L2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(DW_L2_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = UP_L2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(UP_L2_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = UP_L3_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(UP_L3_GPIO_Port, &GPIO_InitStruct);
}
...
static void MX_TIM8_Init(void) {
  ...
  */
  ...
  LL_TIM_IC_SetActiveInput(TIM8, LL_TIM_CHANNEL_CH1,
                           LL_TIM_ACTIVEINPUT_DIRECTTI);
  LL_TIM_IC_SetPrescaler(TIM8, LL_TIM_CHANNEL_CH1, LL_TIM_ICPSC_DIV1);
  LL_TIM_IC_SetFilter(TIM8, LL_TIM_CHANNEL_CH1, LL_TIM_IC_FILTER_FDIV16_N5);
  LL_TIM_IC_SetActiveInput(TIM8, LL_TIM_CHANNEL_CH2,
  ...
  LL_DMA_ConfigAddresses(
      DMA2, LL_DMA_STREAM_3, (uint32_t)&TIM8->CCR2, (uint32_t)&vacs[1],
      LL_DMA_GetDataTransferDirection(DMA2, LL_DMA_STREAM_3));
  LL_DMA_EnableStream(DMA2, LL_DMA_STREAM_3);
  /**/
  LL_DMA_SetDataLength(DMA2, LL_DMA_STREAM_4, 1);
  LL_DMA_ConfigAddresses(
      DMA2, LL_DMA_STREAM_4, (uint32_t)&TIM8->CCR3, (uint32_t)&vacs[2],
  ...
  LL_DMA_ConfigAddresses(
      DMA2, LL_DMA_STREAM_7, (uint32_t)&TIM8->CCR4, (uint32_t)&vacs[3],
...
static void MX_DMA_Init(void) {
  ...
  /* DMA interrupt init */
  /* LL_DMA_STREAM_0 interrupt configuration */
  NVIC_SetPriority(LL_DMA_STREAM_0,
                   NVIC_EncodePriority(NVIC_GetPriorityGrouping(), 6, 0));
  NVIC_EnableIRQ(LL_DMA_STREAM_0);
